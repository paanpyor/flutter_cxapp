...
class _RestaurantDetailsOwnerPageState
  ...
  String _generateAnalysis() {
    ...
    if (_avgCSAT < 5) {
      analysis +=
          "😟 CSAT (Customer Satisfaction) is quite low. Customers may not be happy with food or service quality.\n"
          "➡️ Try improving the dining experience, speed of service, and overall food taste.\n\n";
    } else if (_avgCSAT >= 5 && _avgCSAT < 8) {
      analysis +=
          "🙂 CSAT is moderate. Most customers are somewhat satisfied but there's room for improvement.\n"
          "➡️ Encourage staff friendliness and ensure consistency in service.\n\n";
    } else {
      analysis +=
          "😄 CSAT is excellent! Customers are very happy. Keep up the good work and maintain quality.\n\n";
    }

    if (_avgCES > 6) {
      analysis +=
          "⚠️ CES (Customer Effort Score) is high — customers find it difficult to complete their experience.\n"
          "➡️ Make ordering or problem-solving easier, maybe improve app/website usability or reduce waiting time.\n\n";
    } else {
      analysis +=
          "💪 CES is good — customers find it easy to interact with your restaurant systems.\n\n";
    }

    if (_avgNPS < 0) {
      analysis +=
          "🚫 NPS (Net Promoter Score) is negative — customers might not recommend your restaurant.\n"
          "➡️ Collect feedback from detractors to identify what went wrong.\n\n";
    } else if (_avgNPS >= 0 && _avgNPS < 50) {
      analysis +=
          "😐 NPS is average. Some customers are promoters, but others are neutral or detractors.\n"
          "➡️ Consider offering loyalty programs or discounts for repeat customers.\n\n";
    } else {
      analysis +=
          "🔥 NPS is strong! Many customers would recommend your restaurant.\n"
          "➡️ Continue maintaining high standards and encourage reviews.\n\n";
    }
              ...
              : SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(_restaurant!["name"] ?? "Unnamed Restaurant",
  ...
  Widget _buildChartSection() {
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            const Text("Survey Performance Overview",
                style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    color: Colors.indigo)),
    ...
    return Card(
      ...
      child: SizedBox(
        ...
        child: _restaurantLocation == null
            ? const Center(
                child: Text("No location data for this restaurant."))
            : ClipRRect(
